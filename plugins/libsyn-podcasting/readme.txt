...
+ In order to install and activate this plugin in Wordpress, you will need __PHP 5.3 or higher__, Wordpress must be version 4.0 or higher.
...
* iTunes optimization tags added to posts.
