				...
				foreach($published_destinations as $published_destination) {
					if(isset($published_destination->destination_id)) {
						if($published_destination->destination_id === $destination->destination_id){
							...
							$publishedReleaseRadio = '
								<label>
									<input type=\"radio\" name=\"set_release_scheduler_advanced_release_lc__' . $destination->destination_id . '\" id=\"set_release_scheduler_advanced_release_lc__' . $destination->destination_id . '-1\" value=\"1\" checked=\"checked\" class=\"libsyn-form-element\" autocomplete=\"off\">
										Release '.$releaseDate.'
								</label><br />';
							if (!empty($expirationDate)) {
								$expirationReleaseRadio = '
									<label>
										<input type=\"radio\" name=\"set_expiration_scheduler_advanced_release_lc__' . $destination->destination_id . '\" id=\"set_expiration_scheduler_advanced_release_lc__' . $destination->destination_id . '-1\" value=\"0\" checked=\"checked\" class=\"libsyn-form-element\" autocomplete=\"off\">
