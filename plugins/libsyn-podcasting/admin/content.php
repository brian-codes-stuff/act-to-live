				...
				<div class="inside" style="margin: 15px;">
				  <table class="form-table">
					<tr valign="top">
					  ...
					  <td valign="top">
						<div class="libysn-help-tip-container" style="position:relative;">
							<?php submit_button(__('Create New Episode', $libsyn_text_dom), 'primary', 'libsyn_create_post', false, array('id' => 'submit_create_post_top')); ?>
							&nbsp;
