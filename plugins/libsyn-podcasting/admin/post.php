...
<?php /* MATERIALIZE AND NEW SCRIPTS */ ?>
<?php wp_enqueue_style( 'materialize', 'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-beta/css/materialize.min.css' ); ?>
<?php wp_enqueue_style( 'animate', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css' ); ?>
<?php wp_enqueue_script( 'materialize', 'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-beta/js/materialize.min.js' ); ?>
			...
			$(document).ready(function(){
				...
				function createTable(tableData) {
					...
					if(typeof tableData[0] !== 'undefined') {
						...
						var editEpisodeButton = '<div style="padding:12px;"><button type="button" name="libsyn_edit_post" id="submit_edit_post" onClock="document.getElementById(\'submit_edit_post\').value=\'Edit Episode\';" class="button libsyn-dashicions-edit">Edit Episode</button>&nbsp;&nbsp;<button type="button" name="libsyn_create_post" id="submit_create_post" onClock="document.getElementById(\'submit_create_post\').value=\'Create New Episode\';" class="button libsyn-dashicions-add">Create New Episode</button></div>';
						$("#" + tableData[0].id + "-info-box").append(table).append(editEpisodeButton);
					}
